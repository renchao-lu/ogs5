...
extern "C" __declspec( dllimport )  void invokebrns(double* theCurArray, double* thePreArray, double* outputArray, int* sizeOfArray, double* time_step, int* boundary_flag, int* returnValue, double* pos_x, double* pos_y, double* pos_z, double* porosity, double* waterSaturation, double* parameterVector);
#endif
#endif
