...
bool NUMRead(string file_base_name)
{
  ...
  while (!num_file.eof()) {
    ...
    if(line_string.find("#STOP")!=string::npos)
      return true;
    //----------------------------------------------------------------------
    if(line_string.find("#NUMERICS")!=string::npos) { // keyword found
...
ios::pos_type CNumerics::Read(ifstream *num_file)
{
  ...
  while(!new_keyword) {
    ...
    //....................................................................
    if(line_string.find("$RENUMBER")!=string::npos) { // subkeyword found
	  line.str(GetLineFromFile1(num_file));
    ...
    //....................................................................
    if(line_string.find("$NON_LINEAR_SOLVER")!=string::npos) { // subkeyword found
	  line.str(GetLineFromFile1(num_file));
    ...
    //....................................................................
    if(line_string.find("$LINEAR_SOLVER")!=string::npos) { // subkeyword found
	  line.str(GetLineFromFile1(num_file));
      line >> ls_method;
    ...
    //....................................................................
    if(line_string.find("$ELE_GAUSS_POINTS")!=string::npos) { // subkeyword found
	  line.str(GetLineFromFile1(num_file));
      line >> ele_gauss_points; // probably element-type-wise
      line.clear();
      continue;
    }
    if(line_string.find("$ELE_MASS_LUMPING")!=string::npos) { // subkeyword found
	  line.str(GetLineFromFile1(num_file));
    ...
    if(line_string.find("$DYNAMIC_DAMPING")!=string::npos) { // subkeyword found
	  line.str(GetLineFromFile1(num_file)); //WW
