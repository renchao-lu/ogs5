...
extern int linear_error_type,linear_error_type_flow,linear_error_type_tran,linear_error_type_temp,linear_error_type_satu;
...
extern IntFuncDXDXL LoeserFlow, LoeserTran, LoeserTemp, LoeserSatu;  /* Funktionszeiger auf Loeser */
...
extern int nonlinear_method_flow, nonlinear_method_tran;  /* Nichtlinear-Gleichungsloeser-Nummern */
extern int nonlinear_maxiter_flow, nonlinear_maxiter_tran;  /* max. Iterationen fuer Nichtlinear-Loeser */
extern int nonlinear_convergence_type_flow, nonlinear_convergence_type_tran; /* Konvergenztyp fuer Nichtlinear-Loeser */
extern double nonlinear_abs_eps_flow, nonlinear_abs_eps_tran;  /* abs. Abbruchkriterium */
extern double nonlinear_rel_eps_flow, nonlinear_rel_eps_tran;  /* rel. Abbruchkriterium */
extern double nonlinear_rel_cg_eps,nonlinear_rel_cg_eps_flow, nonlinear_rel_cg_eps_tran; /* rel. Genauigkeit fuer CG-Loeser */
extern int nonlinear_assemble_flow, nonlinear_assemble_tran;  /* Wiederaufbau des globalen Systems */
