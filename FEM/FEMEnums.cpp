...
//	if (pcs_pv_string.compare ("STRAIN_PLS") == 0) return STRAIN_PLS;
	...
	if (pcs_pv_string.compare ("bacn") == 0) return BaCn; //!< Barium Copernicum or Barium Carbon Nitrogen ?
	if (pcs_pv_string.compare ("bacc") == 0) return BaCC;
	if (pcs_pv_string.compare ("bacm") == 0) return BaCm; //!< Barium Curium
	if (pcs_pv_string.compare ("bacf") == 0) return BaCf; //!< Barium Californium
	if (pcs_pv_string.compare ("bacs") == 0) return BaCs; //!< Barium Caesium
