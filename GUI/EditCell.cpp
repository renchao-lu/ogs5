...
//
/**************************************************************************
GeoSys GUI - Object: Edit Control
Task: 
Programing:
...
CMyEditCell::CMyEditCell (CMyListCtrl* pCtrl, int iItem, int iSubItem, CString sInitText)
:   bEscape (FALSE)
{
    pListCtrl = pCtrl;
    Item = iItem;
...
CMyEditCell::~CMyEditCell()
{
}

BEGIN_MESSAGE_MAP(CMyEditCell, CEdit)
    //{{AFX_MSG_MAP(CMyEditCell)
    ON_WM_KILLFOCUS()
    ON_WM_NCDESTROY()
    ON_WM_CHAR()
    ON_WM_CREATE()
...
**************************************************************************/
BOOL 
CMyEditCell::PreTranslateMessage (MSG* pMsg) 
{
...
**************************************************************************/
void 
CMyEditCell::OnKillFocus (CWnd* pNewWnd) 
{
...
**************************************************************************/
void 
CMyEditCell::OnKeyDown (UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
**************************************************************************/
void 
CMyEditCell::OnKeyUp (UINT nChar, UINT nRepCnt, UINT nFlags) 
{
    switch (nChar)
    {
		case VK_NEXT :
...
**************************************************************************/
void 
CMyEditCell::OnChar (UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
**************************************************************************/
int 
CMyEditCell::OnCreate (LPCREATESTRUCT lpCreateStruct) 
{
