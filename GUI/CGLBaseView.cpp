/******************************************************/
// CGLBaseView.cpp : implementation file for PICKING by PCH
//
...
void CGLBaseView::MouseSet(HCURSOR mouseType)
{
	m_hMouseCursor=mouseType;
}
...
void CGLBaseView::OnDrawGL(void)
{
	
}

void CGLBaseView::SetStopOnDrawGL(BOOL Switch)
{
	StopOnDrawGL = Switch;
}
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// CGLBaseView initialization and palette helpers

BOOL CGLBaseView::bSetupPixelFormat()
{
...
/////////////////////////////////////////////////////////////////////////////
// CGLBaseView message handlers and overridables
...
CRect CGLBaseView::viewport(void)
{
	return m_ClientRect;
}

void CGLBaseView::OnSizeGL(int cx, int cy)
{
...
//			glTranslatef(0.0f,0.0f,theApp->zoomRatio);
			glTranslated(theApp->mouseX, theApp->mouseY,theApp->zoomRatio);
		glMatrixMode(GL_MODELVIEW);
	glPopMatrix();
}

BOOL CGLBaseView::OnSetCursor(CWnd* /*pWnd*/, UINT /*nHitTest*/, UINT /*message*/) 
{
...
/////////////////////////////////////////////////////////////////////////////
// CGLBaseView public members

void CGLBaseView::VideoMode(ColorsNumber &c, ZAccuracy &z, BOOL &dbuf)
{
...
void CGLBaseView::SetMouseCursor(HCURSOR mcursor)
{
	// set the specified cursor (only if it is a valid one)
	if(mcursor!=NULL) m_hMouseCursor=mcursor;
}

const CString CGLBaseView::GetInformation(InfoField type)
{
	PIXELFORMATDESCRIPTOR pfd;
...
void CGLBaseView::DrawStockDispLists()
{
...
void CGLBaseView::StartStockDListDef()
{
...
void CGLBaseView::EndStockListDef()
{
	// close the disp list
	glEndList();
	// unset the semaphore
...
void CGLBaseView::ClearStockDispLists()
{
...
void CGLBaseView::BeginGLCommands()
{
	// check if we are inside a drawing session or not....
	if(!( m_hRC==wglGetCurrentContext() && m_pCDC->GetSafeHdc()==wglGetCurrentDC() ))
	{
...
void CGLBaseView::EndGLCommands()
{
...
//////////////////////////////////////////////////////////////////////
//
// Implementation of CGLBaseView::CGLDispList class.
//
/*** DESCRIPTION

  This is actually a helper class which wraps the
  use of display list in OGL.
  It must be used inside an GLBaseView cause
...
CGLBaseView::CGLDispList::CGLDispList():
...
void CGLBaseView::CGLDispList::Draw()
{
...
void CGLBaseView::CGLDispList::StartDef(BOOL bImmediateExec)
{
...
void CGLBaseView::CGLDispList::EndDef()
{
...
//////////////////////////////////////////////////////////////////////
//
// Implementation of CGLBaseView::CGLTesselator class.
//
/*** DESCRIPTION
...
CGLBaseView::CGLTesselator::CGLTesselator()
{
...
void CGLBaseView::CGLTesselator::SetWindingRule(GLdouble which)
{
	// issue the equivalent GL call
	gluTessProperty(m_tessObj,GLU_TESS_WINDING_RULE,which); 
}

GLdouble CGLBaseView::CGLTesselator::GetWindingRule()
{
	//retrieve attribute
	GLdouble temp=0.;
...
void CGLBaseView::CGLTesselator::SetFilling(BOOL bFill)
{
...
BOOL CGLBaseView::CGLTesselator::GetFilling()
{
	//retrieve attribute
	GLdouble temp=0.;
...
void CGLBaseView::CGLTesselator::StartDef()
{
...
void CGLBaseView::CGLTesselator::EndDef()
{
...
void CGLBaseView::CGLTesselator::ContourSeparator()
{
...
void CGLBaseView::CGLTesselator::AddVertex(GLdouble vertData[3])
{
...
void CGLBaseView::CGLTesselator::AddVertexArray(GLdouble arr[][3], int size)
{
	ASSERT(arr!=NULL);
...
//////////////////////////////////////////////////////////////////////
//
// Implementation of CGLBaseView::CGLQuadric class.
//
/*** DESCRIPTION
...
CGLBaseView::CGLQuadric::CGLQuadric(GLenum drwStyle,GLenum normals,GLenum side,BOOL bGenerateTxtrCoords)
{
...
CGLBaseView::CGLQuadric::~CGLQuadric()
{
...
void CGLBaseView::CGLQuadric::SetNormals(GLenum type)
{
...
void CGLBaseView::CGLQuadric::SetTextureCoordsGen(BOOL flag)
{
...
void CGLBaseView::CGLQuadric::SetOrientation(GLenum type)
{
	// check validity of type parameter it must be one of these:
...
void CGLBaseView::CGLQuadric::SetDrawStyle(GLenum style)
{
	// check validity of type parameter it must be one of these:
...
void CGLBaseView::CGLQuadric::DrawSphere(GLdouble radius, int longitudeSubdiv, int latitudeSubdiv)
{
	// issue corresponding GL command
	gluSphere(m_quadrObj,radius,longitudeSubdiv,latitudeSubdiv);
}

void CGLBaseView::CGLQuadric::DrawCylinder(GLdouble baseRadius,GLdouble topRadius,GLdouble height,int slices,int stacks)
{
	// issue corresponding GL command
	gluCylinder(m_quadrObj,baseRadius,topRadius,height,slices,stacks);
}

void CGLBaseView::CGLQuadric::DrawDisk(GLdouble innerRadius,GLdouble outerRadius,int slices,int loops)
{
	// issue corresponding GL command
	gluDisk(m_quadrObj,innerRadius,outerRadius,slices,loops);
}

void CGLBaseView::CGLQuadric::DrawPartialDisk(GLdouble innerRadius,GLdouble outerRadius,int slices,int loops,GLdouble startAngle,GLdouble sweepAngle)
{
	// issue corresponding GL command
