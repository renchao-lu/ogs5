#if !defined(AFX_GLBaseVIEW_H__59CED13F_E584_11D1_ACB3_E52ED8AC9002__INCLUDED_)
#define AFX_GLBaseVIEW_H__59CED13F_E584_11D1_ACB3_E52ED8AC9002__INCLUDED_

#if _MSC_VER >= 1000
#pragma once
#endif // _MSC_VER >= 1000
/////////////////////////////////////////////////////////////////////////////
// CGLBaseView.h : header file for PICKING by PCH
//
...
// PCH: The followin two lines are commented out because of conflicting with TK's OpenGL.
...
// Rendering Context switching
	...
	void SetStopOnDrawGL(BOOL Switch);
	void MouseSet(HCURSOR mouseType);
// Overridables
	...
	virtual void OnDrawGL(void); // override to issue drawing functions
...
private:
	...
	int m_DispListVector[100];	// Internal stock display list vector
...
#endif // !defined(AFX_GLBaseVIEW_H__59CED13F_E584_11D1_ACB3_E52ED8AC9002__INCLUDED_)
